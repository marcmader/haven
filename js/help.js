    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: 'Quick Notes',            desc: 'Einstellungen → Allgemein → „Quick Notes im Hero-Bereich anzeigen" aktivieren. Ein Notizfeld erscheint rechts neben der Hero-Kachel. Autosave bei jeder Eingabe, ausschließlich lokal gespeichert.' },
          { term: 'Standort (Wetter)',      desc: 'Der Standort wird beim ersten Start einmalig per Geolocation abgefragt und lokal gespeichert – danach kein Browser-Prompt mehr. Einstellungen → Allgemein → „Neu bestimmen" um den Standort zu aktualisieren.' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: 'Quick Notes',            desc: 'Settings → General → enable "Show Quick Notes in hero area". A note field appears to the right of the hero card. Auto-saves on every keystroke, stored locally only.' },
          { term: 'Location (Weather)',     desc: 'Your location is requested once via geolocation on first launch and stored locally — no repeated browser prompts. Settings → General → "Re-detect" to update the stored location.' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: 'Quick Notes',            desc: 'Paramètres → Général → activer „Afficher Quick Notes dans la zone principale". Un champ de notes apparaît à droite de la carte principale. Sauvegarde automatique à chaque frappe, stocké localement.' },
          { term: 'Localisation (Météo)',   desc: 'La localisation est demandée une seule fois au premier démarrage via la géolocalisation et stockée localement — plus de demandes répétées. Paramètres → Général → „Relocaliser" pour mettre à jour.' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: 'Quick Notes',            desc: 'Ajustes → General → activar „Mostrar Quick Notes en el área principal". Aparece un campo de notas a la derecha de la tarjeta principal. Guardado automático con cada pulsación, almacenado solo localmente.' },
          { term: 'Ubicación (Tiempo)',     desc: 'La ubicación se solicita una sola vez al primer inicio mediante geolocalización y se guarda localmente — sin más solicitudes del navegador. Ajustes → General → „Volver a detectar" para actualizarla.' },
